...
public class Utility {
    ...
    public void openBrowser1(String baseUrl){
    ...
    public void openBrowser2(String baseUrl){
    ...
    public void openBrowser3(String baseUrl) {
    ...
    public void sortingZToA(By by) {
        ...
        Collections.reverse(sortedList); // collections method to sort list
